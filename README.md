...
`profile/assets/` holds rendered cuts of the lockup and Roundel seal. They are build outputs of the brand render pipeline (private repository) — never hand-edited. To update one, re-render upstream and copy the output here.
